...
private fun CardContent(name: String){
    ...
    Row(
        ...
        Column(modifier = Modifier
            ...
            if (expanded){
                Text(text = ("Compose uses colors in a lazy way." + "Padding is themed nicely, with bouncy animations.").repeat(4))
            }
        }
...
fun OnboardingPreview(){
    JetpackComposeBasicTheme {
        OnboardingScreen(onContinueClicked = {}) //Do nothing click.
    }
}
